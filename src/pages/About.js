        ...
        <div className="about-cont">
            ...
            <div className="paras">
                ...
                <p className="title-pic">
                    <h1>The Creator</h1>
                    <div><img src={profile} className="profile-pic" alt="profile"/></div>
                </p>
